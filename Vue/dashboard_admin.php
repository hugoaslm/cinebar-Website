...
<body>
    ...
    <main class="choix">
        ...
        <p>Gérer les films, événements, salles et projections avec facilité.</p>

        <div class="admin-buttons">
            <a href="gestion_films">
            ...
            <a href="gestion_events">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 16h-2v-6H8V9h6v7h2V9h4v9h-6v-4z"/>
                </svg>
                Gestion des événements
            </a>
            <a href="gestion_salles">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 16h-2v-6H8V9h6v7h2V9h4v9h-6v-4z"/>
                </svg>
                Gestion des salles
            </a>
            <a href="gestion_projections">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 16h-2v-6H8V9h6v7h2V9h4v9h-6v-4z"/>
                </svg>
